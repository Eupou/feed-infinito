...
function loadPost(profilePicture, profileName, postText, postImgContent) {
    ...
    let postImg = document.querySelectorAll(".post")
...
function likeImg() {
    // the next step is to make the heart with the css and put it on the img 
    this.innerHTML += `
        <div class="container-coracao">
            <div class="coracao">
                <div class="coracao__lado-esquerdo"></div>
                <div class="coracao__lado-direito"></div>
            </div>
        </div>
    ` 
}
